 ...
 */
    ...
    (() => {
        ...
        let number = 2e3 * Math.random();
        btn.onclick = function() {
            wrap.style.transform = "rotate(" + number + 360 + "deg)";
            number += 2e3 * Math.random();
        };
        if (document.querySelector(".slider-people__slider")) new Swiper(".slider-people__slider", {
            loop: true,
            slidesPerView: 4,
            slidesPerGroup: 1,
            speed: 1e3,
        ...
        if (document.querySelector(".cart__slider")) new Swiper(".cart__slider", {
            loop: true,
            slidesPerView: 4,
            speed: 1e3,
            centeredSlides: true,
        ...
        if (document.querySelector(".video-gallery__slider")) new Swiper(".video-gallery__slider", {
            loop: true,
            slidesPerView: 3,
            slidesPerGroup: 1,
            centeredSlides: true,
        ...
        if (document.querySelector(".fitback__slider")) new Swiper(".fitback__slider", {
            loop: true,
            slidesPerView: 3,
            slidesPerGroup: 1,
            speed: 1e3,
